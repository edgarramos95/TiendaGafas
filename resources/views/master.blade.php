...
<body>
	    ...
	    <div class="wrap">
			<div class="header-bottom-left">
	            ...
	            <ul class="megamenu skyblue">
					...
					<li><a class="color4" href="womens.html">Mujeres</a></li>				
					<li><a class="color5" href="mens.html">Hombres</a></li>
				</ul>
			</div>
		</div>
   ...
   <div class="footer">
		...
		<div class="footer-bottom">
			<div class="wrap">
	             <div class="copy">
			        <p>Lunnettes©2017<a href="http://w3layouts.com" target="_blank"></a></p>
		         </div>
				<div class="f-list2">
				 <ul>
