...
<div class="mens">    
  <div class="main">
		...
		<div class="cont span_2_of_3">
		  	<div class="grid images_3_of_2">
		         ...
		         <div class="desc1 span_3_of_2">
		         	<h3 class="m_3">Gafas color naranja para sol</h3>
		             <p class="m_5">Rs. 888 <span class="reducedfrom">Rs. 999</span> <a href="#">Haga clic para obtener una oferta</a></p>
		         	 <div class="btn_form">
						<form>
			   ...
			   <div class="clear"></div>	
	    <div class="clients">
	    <h3 class="m_3">10 productos más de la misma categoría</h3>
		 <ul id="flexiselDemo3">
			<li><img src="images/s5.jpg" /><a href="#">Categoría</a><p>Rs 600</p></li>
			<li><img src="images/s6.jpg" /><a href="#">Categoría</a><p>Rs 850</p></li>
			<li><img src="images/s7.jpg" /><a href="#">Categoría</a><p>Rs 900</p></li>
			<li><img src="images/s8.jpg" /><a href="#">Categoría</a><p>Rs 550</p></li>
			<li><img src="images/s9.jpg" /><a href="#">Categoría</a><p>Rs 750</p></li>
		 </ul>
	...
	<script type="text/javascript" src="js/jquery.flexisel.js"></script>
     ...
     <div class="toogle">
     	<h3 class="m_3">Detalles de producto</h3>
      ...
      <div class="rsidebar span_1_of_left">
		       ...
		       <section  class="sky-form">
					<h4>Nombre de la marca</h4>
						<div class="row row1 scroll-pane">
							<div class="col col-4">
								<label class="checkbox"><input type="checkbox" name="checkbox" checked=""><i></i>Gucci</label>
							</div>
							<div class="col col-4">
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Armani</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Prada</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Silhouette</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Polo Ralph Lauren</label>
								<label class="checkbox"><input type="checkbox" name="checkbox" ><i></i>Fendi</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Guess</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Nike</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Vogue</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Kate Spade</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Ray Ban</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Clavin Klein</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Police</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Tomy Hilfiger</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Tom Ford</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Animal</label>	
							</div>
						</div>
		       </section>
		       <section  class="sky-form">
					<h4>Forma de la mondura</h4>
						<div class="row row1 scroll-pane">
							<div class="col col-4">
							...
							<div class="col col-4">
								...
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Rectangular</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Cuadrado</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Redondo</label>
								<label class="checkbox"><input type="checkbox" name="checkbox" ><i></i>Otros</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Ojos de Gato</label>
								
							</div>
						</div>
		       </section>
		       <section  class="sky-form">
					<h4>Tamaño del marco</h4>
						<div class="row row1 scroll-pane">
							<div class="col col-4">
								<label class="checkbox"><input type="checkbox" name="checkbox" checked=""><i></i>Pequeño</label>
							</div>
							<div class="col col-4">
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Mediano</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Grande</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Mediano</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Grande</label>
							</div>
						</div>
		       ...
		       <section  class="sky-form">
					<h4>Colores</h4>
						<ul class="color-list">
							<li><a href="#"> <span class="color1"> </span><p class="red">Rojo</p></a></li>
							<li><a href="#"> <span class="color2"> </span><p class="red">Verde</p></a></li>
							<li><a href="#"> <span class="color3"> </span><p class="red">Azul</p></a></li>
							<li><a href="#"> <span class="color4"> </span><p class="red">Amarillo</p></a></li>
							<li><a href="#"> <span class="color5"> </span><p class="red">Violeta</p></a></li>
							<li><a href="#"> <span class="color6"> </span><p class="red">Naranja</p></a></li>
							<li><a href="#"> <span class="color7"> </span><p class="red">Gris</p></a></li>
					   </ul>
		       </section>
		      </div>
			<div class="clear"></div>
